<x-contacts-layout>
    <x-slot name="title">Edytuj kontakt</x-slot>
    
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h1 class="text-2xl font-bold text-gray-900">Edytuj kontakt: {{ $contact->full_name }}</h1>
    ...
    <div class="max-w-2xl mx-auto">
            ...
            <form method="POST" action="{{ route('contacts.update', $contact) }}" class="space-y-6">
                ...
                @if($contact->tags->count() > 0)
                    <div class="bg-gray-50 rounded-lg p-4">
                        <h4 class="text-sm font-medium text-gray-700 mb-2">Aktualnie przypisane tagi:</h4>
        ...
        <div class="mt-6 bg-gray-50 border border-gray-200 rounded-lg p-4">
            <div class="flex items-start">
                ...
                <div class="ml-3">
                    <h3 class="text-sm font-medium text-gray-800">Informacje o kontakcie</h3>
                    <div class="mt-2 text-sm text-gray-600">
                        <p><strong>Utworzony:</strong> {{ $contact->created_at->format('d.m.Y H:i') }}</p>
                        <p><strong>Ostatnia modyfikacja:</strong> {{ $contact->updated_at->format('d.m.Y H:i') }}</p>
                        @if($contact->creator)
                            <p><strong>Utworzony przez:</strong> {{ $contact->creator->name }}</p>
                        @endif
                    </div>
                </div>
            </div>
                ...
                <div class="ml-3">
                    ...
                    <div class="mt-2 text-sm text-blue-700">
                        <ul class="list-disc list-inside space-y-1">
                            ...
                            <li>Zmiany w tagach będą widoczne natychmiast po zapisaniu</li>
